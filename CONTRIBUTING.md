...
```bash
git clone https://github.com/usestapel/stapel-tools.git && cd stapel-tools
...
The packages use a flat layout (`package-dir = {{"stapel_tools": "."}}`), so the
